...
def main():
    ...
    # PSIQ sensory imagery subscales
    ...
    psiq_items = [
        "PSIQ_Appearance", "PSIQ_Sound", "PSIQ_Smell",
        "PSIQ_Taste", "PSIQ_Touch", "PSIQ_Feeling", "PSIQ_Body"
    ]
